 ...
 */
package com.example.project.ktP;
...
import data.mhs.pws.a.exceptions.NonexistentEntityException;
import data.mhs.pws.a.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.example_project.ktp_jar_0.0.1-SNAPSHOTPU");
